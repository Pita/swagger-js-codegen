    ...
    _.forEach(swagger.paths, function(api, path){
        ...
        _.forEach(api, function(op, m){
            ...
            if (op.responses &&
                ...
                _.isString(op.responses['200'].schema.$ref)
            ) {
                var returnTypeSegments = op.responses['200'].schema.$ref.split('/');
                method.responseType = returnTypeSegments[returnTypeSegments.length-1];
            }
